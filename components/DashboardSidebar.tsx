...
const DashboardSidebar = () => {
  return (
    <div className="xl:w-[400px] bg-[#00d08e] h-full max-xl:w-full">
      <Link href="/admin">
        <div className="flex gap-x-2 w-full hover:bg-[#00b87d] cursor-pointer items-center py-6 pl-5 text-xl text-white">
